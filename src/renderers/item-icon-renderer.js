...
class ItemIconRenderer {
  ...
  static drawVector(ctx, kind, x, y, color, size) {
    ...
    else if (kind === "weaponCore") ItemIconAuxRenderer.weaponCore(ctx, x, y, scale, color);
    else if (kind === "bonus") this.overdrive(ctx, x, y, scale, color);
    else ItemIconAuxRenderer.star(ctx, x, y, scale, color);
  }
  ...
  static weapon(ctx, kind, x, y, scale, color) {
    ...
    ItemIconAuxRenderer.star(ctx, x, y, scale, color);
  }
